      ...
      <div className="container">
        ...
        <div className="flex lg:gap-x-10">
          ...
          <div className="flex space-x-4 lg:hidden">
            <div
              className={`fixed top-0 right-0 h-screen w-[85%] max-w-[380px] bg-white text-zinc-800 transform transition-transform duration-300 z-[9999] shadow-2xl ${isFilterOpen ? "translate-x-0" : "translate-x-full"
                }`}
            >
              <div className="flex flex-col h-screen">
                ...
                >
                    ...
                    <div className="space-y-3">
                      {categoryData.map((item, index) => (
                        <div
                          key={index}
                          onClick={() =>
                            hanldeCategoryChange(item.customURL)
                          }
                  ...
                  <div className="mt-4 pb-16">
                    ...
                    <h6 className="font-semibold mt-4 mb-4">
                      By Price
                    </h6>
                    ...
                    <div className="mt-3 text-center">
                      ...
                      >
                        ₹{Number(range?.[0] || 0).toLocaleString("en-IN")}
                        {" - "}
                        ₹{Number(range?.[1] || 10000).toLocaleString("en-IN")}
                      </div>
                    </div>
                  </div>
                </div>
