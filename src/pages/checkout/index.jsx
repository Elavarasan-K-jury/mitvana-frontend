...
const Checkout = () => {
  ...
  const handleRazorpayPayment = (e) => {
    ...
    const totalPrice = (
      parseFloat(cartDetail?.totalPrice || 0) + (parseFloat(cartDetail?.shippingPrice) || 0)
    )?.toFixed(2);
              ...
              <div className="checkout-order">
                      ...
                      <div className="d-flex justify-content-between fw-medium border-bottom mb-0 p-2">
                        ...
                        <p className="mb-0 lh-lg">
                          ...
                          {product?.product?.discountedPrice
                            ...
                            : parseFloat(product?.product?.price || 0).toFixed(2)}
                        </p>
                      </div>
                    );
                  })}
                ...
                <div className="d-flex justify-content-between border-bottom mb-0 p-2">
                  ...
                  <p className="mb-0">
                    {cartDetail?.shippingPrice === 0 ? (
                    ...
                    ) : parseFloat(cartDetail?.itemsPrice || 0) >
                      parseFloat(settings?.minCartValueForFreeShipping || Infinity) ? (
                      <>
                        FREE {"  "}
                      ...
                      `₹${
                        ...
                        parseFloat(cartDetail?.shippingPrice || 0).toFixed(2)
                      }`
                    )}
                  </p>
                </div>
