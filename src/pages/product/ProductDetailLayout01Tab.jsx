...
const ProductDetailLayout01Tab = ({
  ...
  const handleClick = (index) => {
    setSelectedItem(productDetail.ingredients[index]);
    setShowModals(true);
  };
  ...
  const handleFileChange = (e, setFile, fileType) => {
    ...
    if (file) {
      ...
      if (!isAllowedFormat) {
        toast.error(
          `Invalid ${fileType} format. Allowed formats: ${fileType === "image"
          ...
          >
            <Row className="nav tab_header justify-content-center">
              <Col>
                <Nav
                  variant="pills"
                  className="product-tabs-nav justify-content-center flex-nowrap overflow-auto"
                >
                  <Nav.Item>
                    <Nav.Link
                    ...
                    <Modal.Body>
                      <div className="flex flex-col items-center">
                        <img
                          ...
                          src={backendUrl + selectedItem?.image}
                          alt={selectedItem?.title}
                        />
                        <p className="mt-3 text-center">{selectedItem?.description}</p>
                      </div>
                    </Modal.Body>
