        ...
        <div className="container">
          ...
          >
                ...
                <div className="accordion-body border-light">
                  {productDetail?.ingredients?.length > 0 &&
                    productDetail?.ingredients.map((item, index) => (
                      <div
                        key={index}
                        className="flex flex-col gap-4 mt-3 mb-3 items-center cursor-pointer"
                      ...
                      >
                        ...
                        {/* Title & Description Visible Only on Click */}
                        {visibleIndex === index && (
                          <div className="text-center">
                            <h5 className="text-[18px] m-0">{item?.title}</h5>
                            <p className="text-[14px] m-0">{item?.description}</p>
                          </div>
                        )}
                      </div>
                    ))}
            ...
            <div className="accordion-item border-0 mb-2">
              <h2 className="accordion-header">
                <button
                  className={`accordion-button ${open === 4 ? "" : "collapsed"
                    } bg-light position-relative pe-3`}
                  type="button"
                  data-bs-toggle="collapse"
              ...
              <div
                ...
                className={`accordion-collapse  ${open === 4 ? "show" : "collapse"
                  }`}
                data-bs-parent="#accordionFlushExample"
              >
                <div
            ...
            <div className="accordion-item border-0">
              <h2 className="accordion-header">
                <button
                  className={`accordion-button ${open === 5 ? "" : "collapsed"
                    } bg-light position-relative pe-3`}
                  type="button"
                  data-bs-toggle="collapse"
              ...
              <div
                ...
                className={`accordion-collapse  ${open === 5 ? "show" : "collapse"
                  }`}
                data-bs-parent="#accordionFlushExample"
              >
