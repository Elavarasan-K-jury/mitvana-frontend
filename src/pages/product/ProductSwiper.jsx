                    ...
                    <div className="space-y-2">
                      <p className="text-xs mb-2 font-semibold text-zinc-600">
                        <span style={{ textDecoration: "line-through" }}>
                          MRP: ₹{parseFloat(price)?.toFixed(2)}
                        </span>
                      </p>
                      <p className="fs-28">
                        ₹{parseFloat(productDetail.discountedPrice)?.toFixed(2)}
                      </p>
                      <p className="text-sm text-success">
                        You saved ₹
                        {(
                          parseFloat(price) -
                          parseFloat(productDetail.discountedPrice)
                        ).toFixed(2)}{" "}
                        (
                        {(
                          ((parseFloat(price) -
                      ...
                      <div className="border-2 border-[#193A43] w-40 cursor-pointer rounded-xl overflow-hidden">
                        ...
                        <div className="flex flex-col p-2 justify-around space-y-1">
                          <b className="text-[16px] text-zinc-800">
                            ₹
                            {parseFloat(productDetail?.discountedPrice)?.toFixed(
                              2
                            )}
                          </b>
