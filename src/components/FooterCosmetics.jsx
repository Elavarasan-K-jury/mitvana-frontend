...
const Accordion = () => {
  ...
  return (
    <div className="w-full px-4 py-2 lg:hidden afacad-flux tracking-wider bg-white">
      <AccordionItem
        title="Get In Touch"
          ...
          <div className="flex flex-col gap-4 pt-2">
            ...
            <div className="flex flex-col gap-3">
              <input
                ...
                className="w-full px-3 py-3 rounded-md border border-zinc-300 outline-none focus:border-[#6e8456]"
              />

              <button
                onClick={handleSubscribe}
                className="w-full py-3 rounded-md bg-[#6e8456] text-white font-medium"
              >
                Subscribe
              </button>
            </div>
    ...
    <div className="bg-light pt-24 pb-20">
      ...
      <div className="flex justify-between lg:px-20 pt-20">
        <div className="w-3/5 flex justify-start items-center">
          <p>
            @2026 <span style={{ color: "#6e8456", fontWeight: "bold" }}>Mitvana</span>. All Rights are Reserved
          </p>
        </div>
